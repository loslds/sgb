...
//         <Grid >
//           <Button style={butttonStyle} type='button' color="Success" fullWidth={true} variant='contained' onClick={() => {}}>Cadastrar Senha ?</Button>
//           <Button style={butttonStyle} type='button' color="Success" fullWidth={true} variant='contained' onClick={() => {}}>Recadastrar Senha ?</Button>
//           <Button style={butttonStyle} type='button' color="Success" fullWidth={true} variant='contained' onClick={() => {}}>Recuperar Senha ?</Button>
//         </Grid>
//       </Paper>
//     </Grid>
//   )
